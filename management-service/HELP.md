...
* The original package name 'com.springDemo.management-service' is invalid and this project uses 'com.springDemo.managementservice' instead.
...
```
$ docker run --rm -p 8080:8080 management-service:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/management-service
```
